...
cart.forEach((cartItem)=>{
  // get the product outof the cart first
...
.forEach((link)=>{
  link.addEventListener('click',()=>{
    ...
    if(newQuantity<0||newQuantity>=1000){
      alert('quanity must be at least 0 and less than 1000');
      return;
    }
